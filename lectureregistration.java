...
import java.io.*;
import java.sql.*;
public class lectureregistration extends HttpServlet
{
...
String phone=req.getParameter("tf7");
try
{
...
pw.println("not ok");
PreparedStatement pst=con.prepareStatement("insert into lectureregistration values(?,?,?,?,?,?,?)");
